...
export class ChatHistoryComponent implements OnInit {
  ...
  tempCount: any;
  currentUserName: any = '';
  constructor(public InitialsService: InitialsService, private chatVisibilityService: ChatVisibiltyHumanInteractionService, private _botS: BotMonitoringService, private _spinner: NgxSpinnerService,
